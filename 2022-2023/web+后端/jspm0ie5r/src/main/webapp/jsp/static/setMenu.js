		function setMenu(){
			...
			if(hasMessage != null && hasMessage == '是' && role == '管理员'){
				$('#navUl').append("<li class=\"nav-item dropdown\"><a class=\"nav-link dropdown-toggle\" data-toggle=\"dropdown\" href=\"#\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">留言管理</a><div class=\"dropdown-menu\"><a class=\"dropdown-item\" href="+baseUrl+"jsp/modules/messages/list.jsp"+">留言列表</a></div></li>");
			}
		}