					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">论坛表列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">论坛表列表</h3>							
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
				  ...
				  if(item.content.indexOf('img') != -1){
					...
					contentCell.innerHTML = item.content.substring(beginIndex, endIndex+1);				
				  }else{
