					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">论坛表管理</li>
								<li class="breadcrumb-item active">编辑论坛表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">论坛表信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="isdone" name="isdone" class="form-control" placeholder="是否关闭[关闭/开放]">
																							</div>
	                ...
	                success: function(res){           
	                	if(res.code == 0){
									...
									$("#userid").val(res.data.userid)
															...
															if(res.data.isdone != null && res.data.isdone != ''){
