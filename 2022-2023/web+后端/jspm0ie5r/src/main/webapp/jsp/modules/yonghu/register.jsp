				...
				<div class="col-md-4 col-md-offset-4">
					<div class="account-box">
						<form id="registerForm" action="" method="post">
										...
										<label>用户名</label> 
										<input type="text" name="yonghuming" placeholder="用户名" class="form-control">
										</div>
																																				<div class="form-group">
										<label>密码</label> 
										...
										<input type="text" name="xingming" placeholder="姓名" class="form-control">
																																																																						...
																																																																						<div class="form-group">
										<label>电话</label> 
										<input type="text" name="dianhua" placeholder="电话" class="form-control">
										</div>
																																				<div class="form-group">
										<label>地址</label> 
										<input type="text" name="dizhi" placeholder="地址" class="form-control">
										</div>
