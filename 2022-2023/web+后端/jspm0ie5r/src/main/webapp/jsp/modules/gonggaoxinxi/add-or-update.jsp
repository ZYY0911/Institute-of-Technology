							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<label>公告标题</label>
										<input id="gonggaobiaoti" name="gonggaobiaoti" class="form-control" placeholder="公告标题">
									</div>
											<div class="form-group col-md-6">
																				<label>图片</label>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("gonggaoxinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("gonggaoxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#gonggaobiaoti").val(ruleForm.gonggaobiaoti);	
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												if(res.data != null && res.data != '' && res.data.gonggaobiaoti != null && res.data.gonggaobiaoti != ''){

															$("#gonggaobiaoti").val(res.data.gonggaobiaoti);
													}
