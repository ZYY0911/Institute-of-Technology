		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">影院信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">影院信息列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">影院信息列表</h3>							
	...
	<script>
			...
			row.appendChild(checkbox)
							...
							var yingyuanmingchengCell  = document.createElement('td');
									...
									row.appendChild(yingyuanmingchengCell);
				            				var yingyuantupianCell  = document.createElement('td');

								                  var yingyuantupianImg = document.createElement('img');
				  yingyuantupianImg.setAttribute('src',item.yingyuantupian);
				  yingyuantupianImg.setAttribute('height',100);
				  yingyuantupianImg.setAttribute('width',100);
				  yingyuantupianCell.appendChild(yingyuantupianImg);

				
									row.appendChild(yingyuantupianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yingyuanxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"yingyuanxinxi");
