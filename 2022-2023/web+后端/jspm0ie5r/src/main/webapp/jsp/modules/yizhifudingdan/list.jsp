...
<body>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">已支付订单列表</h3>
	...
	<%@include file = "../../static/toLogin.jsp" %>
		...
		function setDataRow(item, number) {
			...
			//删除按钮
			var fahuoBtn = document.createElement('button');
			var fahuoAttr = 'fahuo(' + item.id + ')';
			fahuoBtn.setAttribute("type", "button");
			fahuoBtn.setAttribute("class", "btn btn-success btn-sm 修改");
			fahuoBtn.setAttribute("onclick", fahuoAttr);
			fahuoBtn.innerHTML = "发货"
			btnGroup.appendChild(fahuoBtn)
