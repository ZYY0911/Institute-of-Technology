							...
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
												...
												<input type="text" id="yonghumingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
																																																														...
																																																														<label>
												密码
												<input type="text" id="mimaSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
											...
											<th class="no-sort" style="min-width: 35px;">
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																													...
																													<th>头像</th>
																																																																	<th onclick="sort('dianhua')">电话<i id="dianhuaIcon" class="fa fa-sort"></i></th>
		...
		function search(){
			searchForm = { key: ""};
					...
					searchForm.yonghuming ="%" +  $('#yonghumingSearch').val() + "%";
																				...
																				if($('#mimaSearch').val() != null && $('#mimaSearch').val() != ''){
					searchForm.mima ="%" +  $('#mimaSearch').val() + "%";
				}
			...
			row.appendChild(checkbox)
				  ...
				  touxiangCell.appendChild(touxiangImg);
									...
									row.appendChild(touxiangCell);
				            				var dianhuaCell  = document.createElement('td');

												 dianhuaCell.innerHTML = item.dianhua;

				
									row.appendChild(dianhuaCell);
