...
<body>
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									<!--  <label> 留言人用户名 <input type="text"
										id="liuyanrenyonghumingSearch"
										class="form-control form-control-sm" placeholder=""
										aria-controls="tableId">
									</label>-->
									<button onclick="getDataList()" type="button" class="btn btn-primary">查询</button>
	...
	<script>
		...
		function search() {
			searchForm = { key: "" };
			if ($('#liuyanrenyonghumingSearch').val() != null && $('#liuyanrenyonghumingSearch').val() != '') {
				searchForm.liuyanrenyonghuming = "%" + $('#liuyanrenyonghumingSearch').val() + "%";
			}
		...
		function crossTable(id, crossTableName) {
			...
			window.sessionStorage.setItem('crossTableName', "liuyanbanguanli");
