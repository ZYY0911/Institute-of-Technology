...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">电影类型管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">电影类型管理</li>
								<li class="breadcrumb-item active">电影类型列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">电影类型列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																									<label>
												类型
												<input type="text" id="leixingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
													if($('#leixingSearch').val() != null && $('#leixingSearch').val() != ''){
					searchForm.leixing ="%" +  $('#leixingSearch').val() + "%";
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("dianyingleixing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("dianyingleixing"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"dianyingleixing");
