...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">公告信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">公告信息列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">公告信息列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																									<label>
												公告标题
												<input type="text" id="gonggaobiaotiSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
											...
											<th class="no-sort" style="min-width: 35px;">
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('gonggaobiaoti')">公告标题<i id="gonggaobiaotiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
													if($('#gonggaobiaotiSearch').val() != null && $('#gonggaobiaotiSearch').val() != ''){
					searchForm.gonggaobiaoti ="%" +  $('#gonggaobiaotiSearch').val() + "%";
				}
        ...
        function getDataList() {
			http("gonggaoxinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
																						gonggaobiaoti : searchForm.gonggaobiaoti,	
																																													},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
							...
							var gonggaobiaotiCell  = document.createElement('td');

												 gonggaobiaotiCell.innerHTML = item.gonggaobiaoti;

				
									row.appendChild(gonggaobiaotiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("gonggaoxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"gonggaoxinxi");
