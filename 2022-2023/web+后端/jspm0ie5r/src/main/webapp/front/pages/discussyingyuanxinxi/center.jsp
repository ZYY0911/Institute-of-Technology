					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="refid" id="refid" placeholder="关联表id" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="reply" id="reply" placeholder="回复内容" autocomplete="off" class="layui-input">
							</div>
						</div>
