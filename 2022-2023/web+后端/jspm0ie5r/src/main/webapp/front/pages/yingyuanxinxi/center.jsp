						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="yingyuanmingcheng" id="yingyuanmingcheng" placeholder="影院名称" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
								<img id="yingyuantupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" src="../../img/avator.png">
								<input type="hidden" id="yingyuantupian" name="yingyuantupian" />
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block">
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function() {
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					form.val("myForm", data.data);
																									// 图片赋值
					jquery("#yingyuantupianImg").attr("src", data.data.yingyuantupian);
																																		});
