		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`yingyuanxinxi`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.yingyuanmingcheng;
																				// 轮播图片
					vue.swiperList = vue.detail.yingyuantupian ? vue.detail.yingyuantupian.split(",") : [];
																																			var swiperItemHtml = '';
