		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input type="text" name="shangyingriqi" id="shangyingriqi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.zhuyan" type="text" name="zhuyan" id="zhuyan" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">预告：</label>
						<div v-if="detail.yugao" class="layui-input-block">
							<video style="width: 100%;" :src="detail.yugao" controls="controls">
								您的浏览器不支持视频播放
							</video>
                            <input type="hidden" :value="detail.yugao" id="yugao" name="yugao" />
						</div>
						<div class="layui-input-block">
							<button type="button" class="layui-btn btn-theme" id="yugaoUpload">
								<i class="layui-icon">&#xe67c;</i>上传预告
							</button>
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
                        ...
                        <div class="layui-input-block">
                            <select name="yingyuanmingcheng" id="yingyuanmingcheng" lay-filter="yingyuanmingcheng">
                                <option value="">请选择</option>
						...
						<div class="layui-input-block">
							<input type="text" name="changci" id="changci" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="dianyingjianjie" id="dianyingjianjie">请输入电影简介</textarea>
						</div>
					</div>
				...
				var haibaoUpload = upload.render({
					...
					// 上传成功
						...
						if (res.code == 0) {
							...
							var url = http.baseurl + 'upload/' + res.file;
							jquery('#yugao').val(url);
                            vue.detail.yugao = url;
						} else {
							layer.msg(res.msg, {
								time: 2000,
								icon: 5
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					...
                                                                                                                                                                                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var dianyingjianjie = tinymce.get('#dianyingjianjie').getContent()
					data.dianyingjianjie = dianyingjianjie;
