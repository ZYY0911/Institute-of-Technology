				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="gonggaobiaoti" id="gonggaobiaoti" placeholder="公告标题" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
								<img id="tupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" src="../../img/avator.png">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="faburiqi" id="faburiqi" placeholder="发布日期" autocomplete="off" class="layui-input">
							</div>
						</div>
