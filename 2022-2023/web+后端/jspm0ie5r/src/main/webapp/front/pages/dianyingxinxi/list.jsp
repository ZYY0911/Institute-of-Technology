			...
			<div class="data-container layui-row">
				...
				<fieldset class="search-container">
					<form class="layui-form">
							...
							<div class="layui-input-inline">
								<input type="text" name="leixing" id="leixing" placeholder="类型" autocomplete="off" class="layui-input">
							</div>
						</div>   
                                                                                                                                                                                                <div class="layui-inline" style="margin-bottom: 10px;">
							...
							<div class="layui-input-inline">
								<input type="text" name="yingyuanmingcheng" id="yingyuanmingcheng" placeholder="影院名称" autocomplete="off" class="layui-input">
							</div>
						</div>   
						...
						<div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
							...
							<button v-if="isAuth('dianyingxinxi','新增')" @click="jump('../dianyingxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
				...
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../dianyingxinxi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" v-bind:key="index"
					 class="data-item layui-col-md3">
						
						                                                                                                                                                                                                <img :src="item.haibao?item.haibao.split(',')[0]:''" class="cover">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                						
												                        <h3 class="title">{{item.dianyingmingcheng}}</h3>
